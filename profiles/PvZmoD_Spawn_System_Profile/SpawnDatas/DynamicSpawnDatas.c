...
ref autoptr TIntArray data_CountrySide =	{ 1,		30,			45,			2,			5,			180,		100,			30,					1 };			// 1 DEFAULT (Countryside)

ref autoptr TIntArray data_SmallTwon =		{ 10,		15,			20,			2,			3,			120,		50,				30,					10 };			// 10 SmallTwon
ref autoptr TIntArray data_AverageTown =	{ 20,		13,			25,			3,			5,			120,		60,				50,					20 };			// 20 AverageTown
ref autoptr TIntArray data_BigTown =		{ 30,		10,			20,			5,			10,			80,			60,				60,					30 };			// 30 BigTown
ref autoptr TIntArray data_Building =		{ 40,		25,			30,			4,			6,			110,		5,				30,					40 };			// 40 Building
ref autoptr TIntArray data_Industial =		{ 50,		15,			25,			3,			4,			110,		50,				30,					50 };			// 50 Industial
ref autoptr TIntArray data_Military =		{ 60,		15,			25,			3,			8,			90,			30,				30,					60 };			// 60 Military (always focus)
ref autoptr TIntArray data_Fog =			{ 70,		1,			10,			5,			5,			100,		100,			10,					70 };			// 70 Fog / night
ref autoptr TIntArray data_Prison =			{ 71,		5,			7,			3,			5,			70,			50,				30,					71 };			// 71 Prison (always focus)
ref autoptr TIntArray data_Marines =		{ 72,		0,			0,			0,			0,			0,			0,				0,					0 };			// 72 
ref autoptr TIntArray data_Bridge =			{ 73,		0,			0,			0,			0,			0,			0,				0,					0 };			// 73 
ref autoptr TIntArray data_Config90 =		{ 90,		15,			20,			2,			4,			100,		50,				30,					109 };			// 90 castles

/// Here you can configure your personnal dynamic spawn types
ref autoptr TIntArray data_Config91 =		{ 91,		15,			25,			3,			5,			120,		50,				30,					91 };			// 91 Military / Industrial
ref autoptr TIntArray data_Config92 =		{ 92,		15,			25,			3,			5,			120,		50,				30,					92 };			// 92 Industrial / Military
...
ref autoptr TIntArray data_Config95 =		{ 95,		10,			20,			3,			5,			100,		25,				30,					95 };			// 95 Mix Industrial / Average Town
