...
ref autoptr TStringArray zombieList_01 	= {"ZmbM_HermitSkinny_Green","ZmbM_HermitSkinny_Red",};		// (v1.17 update) (ZmbM_HermitSkinny_Black removed)
...
ref autoptr TStringArray itemList_02 	= {"0.01","Pristine","AntiChemInjector",};
ref autoptr TStringArray vestList_02 	= {"0.1","Random","",};
...
ref autoptr TStringArray itemList_03 	= {"0.15","Pristine","BloodTestKit","CharcoalTablets","Rag","SalineBagIV","TetracyclineAntibiotics","Thermometer","VitaminBottle","Epinephrine", "Morphine", "PainkillerTablets", "CharcoalTablets",}; 
...
ref autoptr TStringArray itemList_05 	= {"0.1","Pristine","LeatherSewingKit","Megaphone","Rag","Rag","Rag","Rag","FirefighterAxe",}; 
ref autoptr TStringArray vestList_05 	= {"0.1","Random","",};
...
ref autoptr TStringArray itemList_06 	= {"0.2","Random","NailBox","NailBox","NailBox","BurlapSack","DuctTape","Hammer","Pliers","SparkPlug","EngineOil","CarBattery","CanisterGasoline","PipeWrench","Pipe",}; 
ref autoptr TStringArray vestList_06 	= {"0.0","Random","",};
ref autoptr TStringArray backList_06 	= {"0.0","Random","",};
ref autoptr TStringArray headgearList_06= {"0.2","Random","WeldingMask","ConstructionHelmet_Lime","ConstructionHelmet_Orange","ConstructionHelmet_Red","ConstructionHelmet_White","ConstructionHelmet_Yellow","ConstructionHelmet_Blue",};
...
ref autoptr TStringArray itemList_09 	= {"0.3","Pristine","Ammo_9x19","Ammo_9x39",};
...
ref autoptr TStringArray backList_09 	= {"0.3","Random","",};
...
ref autoptr TStringArray itemList_11 	= {"0.4","Random","Heatpack","PurificationTablets","Ammo_12gaSlug","Ammo_12gaPellets","Ammo_12gaPellets","Whetstone","Lard","Mackerel","Machete","HuntingKnife","PortableGasLamp","PortableGasStove","Tripod","Compass","Canteen","ChernarusMap",};//"gp_crossbow","gp_Ammo_ArrowBolt","gp_Ammo_ArrowBolt",}; 
...
ref autoptr TStringArray vestList_13 	= {"0.5","Random","Flag_Chernarus","Flag_Chedaki","Flag_NAPA","Flag_CDF","Flag_Livonia","Flag_Altis","Flag_SSahrani","Flag_NSahrani","Flag_DayZ","Flag_LivoniaArmy","Flag_White","Flag_Bohemia","Flag_APA","Flag_UEC","Flag_Pirates","Flag_Cannibals","Flag_Bear","Flag_Wolf","Flag_BabyDeer","Flag_Rooster","Flag_LivoniaPolice","Flag_CMC","Flag_TEC","Flag_CHEL","Flag_Zenit","Flag_HunterZ","Flag_BrainZ",};
...
ref autoptr TStringArray itemList_15	= {"0.2","Pristine","Ammo_9x19","Ammo_9x39",};
ref autoptr TStringArray vestList_15 	= {"0.01","Random","AK_Suppressor","PistolSuppressor",};
...
ref autoptr TStringArray headgearList_17= {"0.9","Ruined","GhillieHood_Tan","GhillieHood_Mossy","GhillieHood_Woodland",}; 
...
ref autoptr TStringArray itemList_22 	= {"0.3","SparkPlug","EngineOil","CarBattery","CanisterGasoline","LugWrench",}; 	
...
ref autoptr TStringArray itemList_23 	= {"0.5","Random","BaseballBat","BaseballBat","BaseballBat","NailedBaseballBat","NailedBaseballBat","BarbedBaseballBat",};
